...
# Python2 Mandelbrot.
#
# Usage: python2.7 Python2/mandelbrot.py <image width> <image height> <max iterations> <repetitions (1+)> <center x> <center y> <section height> <gradient filename> <output filename>
# Example: python2.7 Python2/mandelbrot.py 800 600 200 1 -0.8 0.0 2.2 gradients/benchmark.gradient mandelbrot.raw
#
